...
- (UIButton *)downLoadBtn{
    if (_downLoadBtn == nil) {
        ...
        [_downLoadBtn setImage:[UIImage imageNamed:@"WebImagePhotoBrowser.bundle/News_Picture_Save"] forState:UIControlStateNormal];
...
{
    if (!_countLabel) {
        _countLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreenWidth*0.5, kScreenHeight-40, 60, 30)];
